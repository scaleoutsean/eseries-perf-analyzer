...
PROMETHEUS_METRICS_CONFIG = {
    ...
    'volumes': {
        ...
        'raw_stats': {
            'name': 'eseries_volume_stat_total',
            'desc': 'Raw volume statistics counters from the array',
            'labels': ['sys_id', 'sys_name', 'vol_name', 'stat']
        },
        'throughput': {
...
DRIVE_MAPPING = [
    ("averageReadOpSize", "average_read_op_size", float),
    ("averageWriteOpSize", "average_write_op_size", float),
    ("combinedIOps", "combined_iops", float),
    ("combinedResponseTime", "combined_response_time", float),
    ("combinedThroughput", "combined_throughput", float),
    ("otherIOps", "other_iops", float),
    ("readIOps", "read_iops", float),
    ("readOps", "read_ops", float),
    ("readPhysicalIOps", "read_physical_iops", float),
    ("readResponseTime", "read_response_time", float),
    ("readThroughput", "read_throughput", float),
    ("writeIOps", "write_iops", float),
    ("writeOps", "write_ops", float),
    ("writePhysicalIOps", "write_physical_iops", float),
    ("writeResponseTime", "write_response_time", float),
    ("writeThroughput", "write_throughput", float),
    ("spareBlocksRemainingPercent", "spare_blocks_remaining_percent", float),
    ("percentEnduranceUsed", "percent_endurance_used", float),
]

VOLUME_LIVE_MAPPING = [
    # Derived rates/averages logic (calculated in collector.py)
    ("readIOps", "read_iops", float),
    ("writeIOps", "write_iops", float),
    ("otherIOps", "other_iops", float),
    ("combinedIOps", "combined_iops", float),
    ...
    # Direct explicit API keys (from live-statistics)
    ("cacheBlksInUse", "cache_blocks_in_use", float),
    ("cacheWriteWaitHitBytes", "cache_write_wait_hit_bytes", float),
    ("cacheWriteWaitHitIops", "cache_write_wait_hit_iops", float),
    ("errRedundancyChkIndeterminateReads", "error_redundancy_check_indeterminate_reads", float),
    ("errRedundancyChkRecoveredReads", "error_redundancy_check_recovered_reads", float),
    ("errRedundancyChkUnrecoveredReads", "error_redundancy_check_unrecovered_reads", float),
    ("flashCacheReadHitBytes", "flash_cache_read_hit_bytes", float),
    ("flashCacheReadHitOps", "flash_cache_read_hit_ops", float),
    ("flashCacheReadHitTimeMax", "flash_cache_read_hit_time_max", float),
    ("flashCacheReadHitTimeTotal", "flash_cache_read_hit_time_total", float),
    ("fullStripeWriteBytes", "full_stripe_write_bytes", float),
    ("idleTime", "idle_time", float),
    ("otherOps", "other_ops", float),
    ("otherTimeMax", "other_time_max", float),
    ("otherTimeTotal", "other_time_total", float),
    ("prefetchHitBytes", "prefetch_hit_bytes", float),
    ("prefetchMissBytes", "prefetch_miss_bytes", float),
    ("queueDepthMax", "queue_depth_max", float),
    ("queueDepthTotal", "queue_depth_total", float),
    ("randomBytesTotal", "random_bytes_total", float),
    ("randomIosTotal", "random_ios_total", float),
    ("readBytes", "read_bytes", float),
    ("readHitBytes", "read_hit_bytes", float),
    ("readHitOps", "read_hit_ops", float),
    ("readHitTimeMax", "read_hit_time_max", float),
    ("readHitTimeTotal", "read_hit_time_total", float),
    ("readOps", "read_ops", float),
    ...
    ("writeHitBytes", "write_hit_bytes", float),
    ("writeHitOps", "write_hit_ops", float),
    ("writeHitTimeMax", "write_hit_time_max", float),
    ("writeHitTimeTotal", "write_hit_time_total", float),
    ("writeOps", "write_ops", float),
    ("writeTimeMax", "write_time_max", float),
    ("writeTimeTotal", "write_time_total", float),
]
...
PSU_MAPPING = [
    ("totalPower", "total_power", int),
]

CONFIG_WORKLOADS_MAPPING = [
    ("name", "workload_name_field", str),
    ("workloadAttributes_profileId", "workload_attributes_profile_id", str),
    ("workloadAttributes_isUserDefined", "workload_attributes_is_user_defined", bool)
]
